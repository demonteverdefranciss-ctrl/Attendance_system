    ...
    return (
        <ParentLayout title="Biometric Face Photos">
            ...
            <p className="mb-4 text-sm text-gray-500">
                Upload a close-up of your child&apos;s face only — not a full-body photo, screenshot, or
                unrelated picture. The system rejects photos without a clear face. A teacher then confirms
                it is the correct student (RA 10173 consent required).
            </p>
