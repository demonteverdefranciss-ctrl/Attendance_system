...
export default function TeacherNoClassDays({ days }) {
    return (
        <TeacherLayout title="No-class days">
            <Head title="No-class days" />

            <p className="mb-4 text-sm text-gray-600">
                Holidays and admin-marked no-class days. Sessions will not auto-open on these dates.
                You can still open attendance manually if needed.
            </p>
